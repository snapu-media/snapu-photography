    ...
    <div>
      ...
      <section className="start-sec h-[390px] p-8 flex flex-col justify-center bg-white">
        <div className="main-sec flex flex-col md:flex-row justify-center items-center bg-gradient-to-br from-teal-400 to-indigo-900 rounded-lg p-8 space-y-8 md:space-x-12">
          {/* Left Section */}
          <div className="left p-5 h-[300px] w-[500px] flex flex-col justify-center space-y-5">
            <p className="txt1 text-3xl font-bold text-white">
              Capture Your Moments with Perfection
            </p>
            <p className="txt2 text-lg text-white">
          ...
          <div className="right p-5 h-[300px] w-[300px] flex flex-col justify-center space-y-5 items-center bg-gradient-to-br from-blue-200 to-gray-300 shadow-lg relative overflow-hidden"
               style={{
            ...
            <img
              ...
              alt="Camera Image"
              className="w-[50vw] filter drop-shadow-2xl z-10"
            />
          </div>
        </div>
      </section>
      ...
      <section className="start-sec h-[390px] p-8 flex flex-col justify-center bg-white">
        <div className="main-sec flex flex-col md:flex-row justify-center items-center bg-gradient-to-br from-teal-400 to-indigo-900 rounded-lg p-8 space-y-8 md:space-x-12">
          ...
          <div className="left p-5 h-[300px] w-[300px] flex flex-col justify-center space-y-5 items-center bg-gradient-to-br from-blue-200 to-gray-300 shadow-lg relative overflow-hidden"
               style={{
                  borderBottomLeftRadius: '50%',
                  borderTopRightRadius: '50%',
                  borderTopLeftRadius: '100px',
          ...
          {/* Right Section */}
          <div className="right p-5 h-[300px] w-[500px] flex flex-col justify-center space-y-5">
            <p className="txt1 text-3xl font-bold text-white">
